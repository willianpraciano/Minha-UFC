...
public class MainActivity extends AppCompatActivity
    ...
    private static TextView textNome, textCurso, textMatricula;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Obtendo id do nome, curso e matricula no nav_header_main
    ...
    /*
    Função que checa se o usuário já definiu o seu campus e atualiza os dados do usuário
    na barra lateral
     */
    public void definindoUsuario(TextView tNome, TextView tCurso, TextView tMatricula){
        ...
        if(nome.equals("")){
            tNome.setText("Minha UFC");
        }else{
            tNome.setText(nome);
        }

        if(curso.equals("")){
            tCurso.setText("contato@loadingjr.com.br");
        }else{
            tCurso.setText(curso);
        }

        if(matricula.equals("")){
            tMatricula.setText("Loading Jr.");
        }else{
    ...
    protected void onStart() {
        ...
        //Chama a função definindoUsuario() todas as vez que a MainActivity for iniciada
        definindoUsuario(textNome, textCurso, textMatricula);
...
*/
    ...
    }//Fim do onNavigationItemSelected()
